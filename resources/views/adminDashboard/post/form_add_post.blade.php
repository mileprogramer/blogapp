<form class="form-horizontal" action="/admin/add-tag" method ="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input name="title" type="text" class="form-control" id="fname"
                    placeholder="Insert the name for the tag" required />
            </div>
        </div>
        <div class="form-group row">
            <label for="fname" class="col-sm-3 text-end control-label col-form-label">Text of post</label>
            <div class="col-sm-9">
                <textarea class="form-control" name="body" id="" cols="30" rows="10" placeholder="Type the text for the post"></textarea>
            </div>
        </div>
        <div class="form-group row">
            <label for="fname" class="col-sm-3 text-end control-label col-form-label">Add tags</label>
            <div class="col-sm-9 d-flex position-relative">
                <input id="tagsInput" type="text" data-active="tags" class="form-control w-60" placeholder="Start typing tags">
                <div id="tags-result" class="searched-result"></div>
                <button class="btn btn-info">Add</button>
            </div>
        </div>
        <div class="form-group row">
            <label for="fname" class="col-sm-3 text-end control-label col-form-label">Add category</label>
            <div class="col-sm-9 d-flex position-relative">
                <input id="categoryInput" type="text" data-active="category" class="form-control w-60" placeholder="Start typing category">
