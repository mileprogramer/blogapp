...
<head>
    ...
    <!-- icofont -->
    <link rel="stylesheet" href="{{ asset('css/fontawesome.5.7.2.css') }}">
    <!-- flaticon -->
...
<body>
    ...
    <header class="header-area header-bg" id="home">
            <div class="shape-1"><img src={{ asset("img/shape/01.png")}} alt=""></div>
            <div class="shape-2"><img src={{ asset("img/shape/02.png")}} alt=""></div>
            <div class="shape-3"><img src={{ asset("img/shape/03.png")}} alt=""></div>
        <div class="header-right-image wow zoomIn">
            <img src={{ asset("img/mobile-image-4.png")}} alt="header right image">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="img-with-video">
                    <div class="img-wrap">
                        <img src= {{ asset("img/video-image.jpg")}} alt="">
                        <div class="hover">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="center-image">
                    <img src={{ asset("img/mobile-img-2.png")}} alt="mobile image two">
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="single-why-us-item margin-top-60 wow zoomIn"><!-- single why us item -->
...
<section class="how-it-work-area">
        <div class="shape-1"><img src={{ asset("img/shape/08.png")}} alt=""></div>
        <div class="shape-2"><img src={{ asset("img/shape/09.png")}} alt=""></div>
        <div class="shape-3"><img src={{ asset("img/shape/08.png")}} alt=""></div>
        <div class="shape-4"><img src={{ asset( "img/shape/09.png")}} alt=""></div>
    <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title"><!-- section title -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="right-content-area">
                                            <div class="img-wrapper">
                                                <img src={{ asset("img/how-it-works-image.png")}} alt="how it works image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-12">
                <div class="screenshort-carousel"><!-- screenshort carousel -->
                    <div class="single-screenshort-item"><!-- single screenshort item -->
                        <img src= {{ asset("img/screenshort/screen-1.jpg")}} alt="">
                    </div><!-- //.single screenshort item -->
                    <div class="single-screenshort-item"><!-- single screenshort item -->
                        <img src={{ asset("img/screenshort/screen-2.jpg")}} alt="">
                    </div><!-- //.single screenshort item -->
                    <div class="single-screenshort-item"><!-- single screenshort item -->
                        <img src={{ asset("img/screenshort/screen-3.jpg")}} alt="">
                    </div><!-- //.single screenshort item -->
                    <div class="single-screenshort-item"><!-- single screenshort item -->
                        <img src={{ asset("img/screenshort/screen-4.jpg")}} alt="">
                    </div><!-- //.single screenshort item -->
...
<section class="testimonial-area">
        <div class="shape-1"><img src={{ asset("img/shape/08.png")}} alt=""></div>
        <div class="shape-2"><img src={{ asset("img/shape/08.png")}} alt=""></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="section-title "><!-- section title -->
...
<section class="team-member-area" id="team">
    <div class="bg-shape-1">
        <img src={{ asset("img/bg/team-shape.png")}} alt="">
    </div>
    <div class="bg-shape-2">
        <img src={{ asset("img/bg/contact-map-bg.jpg")}} alt="">
    </div>
    <div class="bg-shape-3">
        <img src={{ asset("img/bg/contact-mobile-bg.png")}} alt="">
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
            ...
            <div class="col-lg-12">
                <div class="team-carousel"><!-- team carousel -->
                    <div class="single-team-member"><!-- single team member -->
                        <div class="thumb">
                            <img src= {{ asset("img/team-member/01.jpg")}} alt="team member image">
                            <div class="hover">
                    ...
                    <div class="single-team-member"><!-- single team member -->
                        <div class="thumb">
                            <img src={{ asset("img/team-member/02.jpg")}} alt="team member image">
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="single-team-member"><!-- single team member -->
                        <div class="thumb">
                            <img src={{ asset("img/team-member/03.jpg")}} alt="team member image">
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="single-team-member"><!-- single team member -->
                        <div class="thumb">
                            <img src={{ asset("img/team-member/04.jpg")}} alt="team member image">
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="single-team-member"><!-- single team member -->
                        <div class="thumb">
                            <img src={{ asset("img/team-member/05.jpg")}}  alt="team member image">
                            <div class="hover">
                                <ul class="social-icon">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget about_widget">
                        <a href="index.html" class="footer-logo"><img src={{ asset("img/logo-white.png")}} alt=""></a>
